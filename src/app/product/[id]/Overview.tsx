...
//                   <picture>
//                     <img src={product?.img} alt="" width="60%" className="img-fluid" />
//                   </picture>
//                 </div>
//                 <div className="col-lg-5">
//                   <div className="product-core mb-3">
//                     <div className="text-muted fs-12 mb-2">Refrigerator</div>
//                     <h1 className="product-title fs-20 fw-bold">{product?.name}</h1>
...
//                     <span className="product-status text-red fw-bold">In stock</span>
//                   ) : (
//                     <span className="product-status text-red fw-bold">Out of stock</span>
//                   )}
//                   <div className="d-flex align-items-center product-total mb-3">
//                     <div className="product-price fw-bold">
//                       &#2547; {numberSeparator(calculatePriceAfterDiscount(product?.price!!, product?.discount!!))}
//                     </div>
//                     <div className="product-prev-price text-red fw-bold">
//                       <del>&#2547; {numberSeparator(product?.price!)}</del>
//                     </div>
//                     <div className="total-save-amount">
//                       <span className="badge bg-red p-2">Save &#2547; {product?.exchangeOffer}</span>
//                     </div>
//                     <div className="total-save-percentage text-red fw-bold">{product?.discount}%</div>
//                   </div>
...
//                           />
//                         </svg>
//                         EMI From {countEMI(product?.price!!, product?.emiDuration!!)} Tk/month
//                       </div>
...
//                         <div className="col-8 col-lg-9">Online Offer (Valid Till: {product?.offerValidityTill})</div>
//                       </div>
//                       <div className="row">
...
//                       </div>
//                     </div>
//                     <ul className="fw-normal mx-3" style={{ listStyleType: "circle" }}>
...
//                         <button className="btn border rounded py-4 px-5">Yes</button>
//                         <button className="btn border rounded py-4 px-5">No</button>
//                       </div>
...
//                           <div className="col text-end">{product?.warrentyType}</div>
//                         </div>
//                       </div>
//                     </div>
